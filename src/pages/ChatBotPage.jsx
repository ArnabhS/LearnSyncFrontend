      ...
      <div className="min-h-screen text-white flex flex-col py-2">
        ...
        <div className="w-full md:w-[96%] lg:w-[90%] mx-auto p-1 md:p-2 flex justify-between gap-1 space-x-2 text-balance mb-10">
          ...
          <div
            ...
            onClick={() =>
              handleCardClick("Where AI Meets Empathy for Meaningful Growth")
            }
          >
            <p className="text-center">
              <span className="text-[#DCECF2]">
        ...
        <div className="mt-8">
          ...
          <div className="w-[90%] md:w-[60%] mx-auto bg-[#5E808DB5] p-4 rounded-lg shadow-lg">
            <p className="text-gray-300">
              However, it is important to remember that these disorders can
              present in a variety of ways and this assessment is based on a
              limited set of questions and answers. If there are concerns about
              any potential disorders, it is always best to consult a medical
