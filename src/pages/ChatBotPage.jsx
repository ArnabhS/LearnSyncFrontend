...
export default function ChatBotPage() {
  const [input, setInput] = useState(""); // State to track the input message

  // Function to handle card clicks and set the message
      ...
      <div className="min-h-screen text-white flex flex-col py-2">
        ...
        <div className="mt-8">
          ...
          <div className="flex w-[90%] md:w-[60%] mx-auto rounded-lg mb-8 bg-[#5E808DB5]">
            ...
            <button className="relative right-2 p-2" onClick={() => sendMessage({ id: nanoid(), isUserMessage: true, text: input })}>
              <SendHorizonal className="text-[#060E12]" />
            </button>
          </div>
