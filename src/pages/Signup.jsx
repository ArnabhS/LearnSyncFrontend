  ...
  return (
    <div className="relative flex flex-col justify-center items-center min-h-screen">
      <div className="relative ">
        <div class="absolute top-0 left-1/2 transform -translate-x-1/2 w-64 h-64 bg-[#3EB1E1] rounded-full blur-3xl opacity-55 z-0"></div>
        <div className="relative z-10 p-10">
          <div className="bg-gradient-to-t from-[#1D6F9199] to-[#09212B99] text-[#DCECF2] flex flex-col justify-center items-center w-[400px] h-[450px] gap-5 rounded-xl px-8">
